...
----
./lets-gopher install --url="https://github.com/bmuschko/go-helloworld-template.git"
...
You can generate a new project from the template if at least one template can be found. The files of a selected template will be written to `$GOPATH/<base-path>`.
